      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-12 sm:px-8 md:grid-cols-3">
        <div>
          ...
          <p className="mt-4 max-w-sm text-sm leading-6 text-blue-100">
            Electric commercial vehicles, local guidance and dependable support
            for Nepal.
          </p>
        </div>
        <div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
            <Link href="/portfolio" className="hover:text-[#31BA58]">
              Vehicles
            </Link>
            <Link href="/supports" className="hover:text-[#31BA58]">
              Support
            </Link>
            <Link href="/about" className="hover:text-[#31BA58]">
              About us
            </Link>
            <Link href="/contact" className="hover:text-[#31BA58]">
              Contact
            </Link>
          </div>
        </div>
        <div>
          ...
          <div className="mt-4 space-y-3 text-sm text-blue-50">
            ...
            >
              <Phone className="h-4 w-4 text-[#31BA58]" />
            ...
            <a
              ...
              className="flex gap-2 hover:text-white"
            >
              <Mail className="h-4 w-4 text-[#31BA58]" />
