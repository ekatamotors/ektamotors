    ...
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col overflow-hidden group">
      ...
      <div className="relative aspect-16/10 bg-slate-100 overflow-hidden">
        ...
        <button
          ...
          className="absolute bottom-3 right-3 bg-white/95 hover:bg-white text-[#041B5F] text-xs font-bold px-3 py-1.5 rounded-full shadow-md flex items-center gap-1.5 transition-all hover:scale-105 cursor-pointer border border-slate-200/80"
        >
          <PlayCircle className="w-4 h-4 text-[#0382DA] fill-[#0382DA]/20" />
          <span>Product Video ({vehicle.video.duration})</span>
        </button>
      </div>
